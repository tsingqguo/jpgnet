...
def npk_val(img_pred_recover, img_gt_recover):
    psnr = compare_psnr(img_gt_recover, img_pred_recover)
...
def eval():
    ...
    load_file_list_recursion('J:/CV/DATA/Celeba/zip/test_256_256', gt)
    load_file_list_recursion('J:/CV/workspace/final/edge-connect-master/checkpoints/results', pre)
