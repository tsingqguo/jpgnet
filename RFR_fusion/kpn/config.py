...
def get_opt():
    ...
    parser.add_argument('--kpn1_model', type=str, default='./checkpoints/1_.pth', help='load pre')
    parser.add_argument('--kpn2_model', type=str, default='./checkpoints/1_kpn.pth', help='load pre')
    ...
    parser.add_argument('--test_interval', type=int, default=1, help='size of the batches')
