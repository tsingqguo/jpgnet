...
def get_opt():
    ...
    parser.add_argument('--kpn1_model', type=str, default='./checkpoints/optimal_29.6083_0.9385', help='load pre')
    parser.add_argument('--kpn2_model', type=str, default='./result/model/5_KPN_bs_8.pth', help='load pre')
    ...
    parser.add_argument('--test_interval', type=int, default=100, help='size of the batches')
