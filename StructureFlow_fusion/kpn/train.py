...
if __name__ == "__main__":
    ...
    parser.add_argument('--no_gpu', type=str2bool, default=True, help='True for CPU')
    parser.add_argument('--save_path', type = str, default = './model', help = 'saving path that is a folder')
    parser.add_argument('--save_by_epoch', type=int, default=1, help='interval between model checkpoints (by epochs)')
    parser.add_argument('--save_by_iter', type=int, default=1, help='interval between model checkpoints (by iterations)')
    parser.add_argument('--save_mode', type=str, default='iter', help='saving mode, and by_epoch saving is recommended')
    parser.add_argument('--epochs', type=int, default=3200, help='number of epochs of training')
    parser.add_argument('--train_data', type=str, default='./data/train', help='images baseroot')
    parser.add_argument('--eval_eval', type=str, default='./data/eval', help='images baseroot')
    parser.add_argument('--mask_data', type=str, default='./data/mask', help='images baseroot')
    ...
    parser.add_argument('--sample_path', type = str, default = './result/samples', help = 'training samples path that is a folder')
